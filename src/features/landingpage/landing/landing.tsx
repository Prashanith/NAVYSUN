  ...
  return (
    <div className=" bg-landing bg-cover bg-no-repeat bg-center h-screen bg-opacity-30 pagePadding">
      ...
      <motion.div
        ...
        className="text-left sm:text-center pt-[20vh] flex flex-col items-start  sm:items-center"
      >
        ...
        <div className="pt-[2vh] sm:pt-[5vh] flex gap-5 sm:flex-row flex-wrap">
          <button
            className="customBtn elevatedBtn uppercase"
            onClick={() => navigate("services")}
          >
            Consulting
          </button>
          <button
            className="customBtn outlinedBtn uppercase"
            onClick={() => navigate("pharmacies")}
          >
            Pharmacies
          </button>
          <button
            className="customBtn textBtn uppercase"

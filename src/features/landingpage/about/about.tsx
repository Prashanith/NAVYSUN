    ...
    <footer className="bg-gray-900  text-teal-400">
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-col justify-start items-start">
          {/* LOGO AND BRAND INFO */}
          <div className="flex justify-between flex-row items-start w-full">
            <div className="flex justify-start items-start flex-row gap-x-3">
              <svg
                className="h-8"
                viewBox="0 0 28 24"
                fill="none"
...
function QuickLinks() {
  return (
    <ul className="text-lg flex flex-col flex-wrap justify-center items-start space-y-5">
      <li>QUICK LINKS</li>
      <li>
        <a
          href="#"
